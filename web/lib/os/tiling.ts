...
/** All window ids in the tree, left-to-right. */
...
/**
 * Edge snap: insert a window as the left or right HALF of the whole tiled
 * region (drag-to-edge gesture). The existing tree keeps the other half.
 */
...
/** Remove a window; the sibling of its parent split takes the whole region. */
...
export interface TileLayout {
  ...
  dividers: { path: TilePath; dir: 'row' | 'col'; rect: Rect }[];
}
