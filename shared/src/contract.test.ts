...
describe('shared contract', () => {
  it('loads all 33 domain descriptor maps', () => {
    ...
    // + schedules (2026-08-17 — landed without bumping this pin, the SECOND time this has
    //   happened; repaired 2026-08-18).
    expect(Object.keys(ALL_ENDPOINTS).length).toBe(33);
  });
