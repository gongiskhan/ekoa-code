 ...
 * "EXMO. SENHOR DOUTOR JUIZ DE DIREITO"). Estas saem a negrito, dando ao
 * documento uma estrutura limpa e editável.
 */
...
/*
 * Constrói o Document a partir do corpo (texto com quebras de linha). Cada linha
 * vira um parágrafo; as linhas em branco viram parágrafos vazios (espaçamento);
 * os cabeçalhos saem a negrito.
 */
